...
//    String salt="ZhraT96O"; // live
    ...
    String merchant_key="VxdLwGxq"; // test
    String salt="MuefyUYC3r"; // test
	 	String action1 ="";
            ...
            mHandler.post(new Runnable() {
                public void run() {
                   ...
                   // new PostRechargeData().execute();
                    ...
                    String typesnew="newstatus";
                    user user =new user (PayMentGateWay.this);
                    tmob=user.getMob();
                    tpass=user.getPass();
                    newBackgroundStatus newbackgroundStatus=new newBackgroundStatus(PayMentGateWay.this);
                    newbackgroundStatus.execute(typesnew,tmob,tpass);
                    Intent intent=new Intent(PayMentGateWay.this,QuestionForm.class);
