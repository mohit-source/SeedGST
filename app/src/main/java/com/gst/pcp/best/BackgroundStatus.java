...
public class BackgroundStatus extends AsyncTask<String,Void,String> {

    Context contextc;
    AlertDialog alertDialog;
    ProgressDialog loading;
    BackgroundStatus (Context ctx) {
        contextc = ctx;
    }
    @Override
    protected String doInBackground(String... params) {
        ...
        String status_url = "http://seedgst.in/updatestatus.php";

        if(types.equals("status")){
            try {
    ...
    protected void onPostExecute(String result) {
        ...
        // alertDialog.show();
       // loading.dismiss();
        Toast.makeText(contextc, "status updated", Toast.LENGTH_SHORT).show();
    }
